import { r as e, c as t, h as i, H as o, g as s } from './p-9031eb6a.js';
import { r as n } from './p-cbcbd1bb.js';
import { b as r } from './p-54ad2682.js';
import './p-8a133b9b.js';
const l = { removeCustomElementInstructions: ', unselecting this custom option will remove it from the list' },
  u = class {
    constructor(i) {
      e(this, i),
        (this.guxremovecustomoption = t(this, 'guxremovecustomoption', 7)),
        (this.internalselectcustomoption = t(this, 'internalselectcustomoption', 7)),
        (this.value = void 0),
        (this.active = !1),
        (this.selected = !1),
        (this.disabled = !1),
    ...
    emitRemoveCustomOption() {
      !this.selected && this.custom && this.guxremovecustomoption.emit();
    }
    handleActive(e) {
      var t, i;
      e
        ? null === (t = this.truncateElement) || void 0 === t || t.setShowTooltip()
        : null === (i = this.truncateElement) || void 0 === i || i.setHideTooltip();
    }
    async componentWillLoad() {
      (this.i18n = await r(this.root, l)),
        (this.root.id = this.root.id || n('gux-option-multi')),
        this.custom && this.internalselectcustomoption.emit(this.value);
    }
    renderCustomOptionInstructions() {
      if (this.custom) return i('span', { class: 'gux-screenreader' }, this.i18n('removeCustomElementInstructions'));
    }
    render() {
      return i(
        o,
        ...
        i('span', { class: 'gux-checkbox-container' }),
        i('gux-truncate-beta', { 'gux-slot-container': !0, ref: e => (this.truncateElement = e) }, i('slot', null)),
    ...
    static get watchers() {
      return { selected: ['emitRemoveCustomOption'], active: ['handleActive'] };
    }
  };
u.style =
