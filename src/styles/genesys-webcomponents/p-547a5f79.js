const a = {
    selectZone: 'Search by region, country, or city',
    default: 'Default',
    all: 'All',
    timeZones: 'Time zones',
    workspaceDefault: '(Workspace default)',
    localDefault: '(Local)',
    localAndWorkspaceDefault: '(Local and Workspace Default)',
  ...
  e = [
    ...
    },
    {
      ...
      group: ['America/Cambridge_Bay', 'America/Edmonton', 'America/Inuvik', 'America/Yellowknife', 'Canada/Mountain'],
      continentCode: 'NA',
      continentName: 'North America',
      countryName: 'Canada',
      countryCode: 'CA',
    ...
    },
    {
      name: 'America/Denver',
      alternativeName: 'Mountain Time',
      group: ['America/Boise', 'America/Denver', 'Navajo', 'US/Mountain', 'America/Shiprock'],
      continentCode: 'NA',
      continentName: 'North America',
      countryName: 'United States',
      countryCode: 'US',
    ...
    },
    {
      ...
      countryName: 'Mexico',
      countryCode: 'MX',
      mainCities: ['Mexico City', 'Iztapalapa', 'León de los Aldama', 'Puebla'],
      rawOffsetInMinutes: -360,
      abbreviation: 'CST',
    ...
    },
    {
      ...
      countryName: 'Mexico',
      countryCode: 'MX',
      mainCities: ['Reynosa', 'Heroica Matamoros', 'Nuevo Laredo', 'Piedras Negras'],
      rawOffsetInMinutes: -360,
      abbreviation: 'CST',
    ...
    },
    {
      ...
      alternativeName: 'Central Time',
      group: ['America/Rankin_Inlet', 'America/Resolute', 'America/Winnipeg', 'Canada/Central', 'America/Rainy_River'],
      continentCode: 'NA',
      continentName: 'North America',
      countryName: 'Canada',
      countryCode: 'CA',
    ...
    },
    {
      ...
      countryName: 'Brazil',
      countryCode: 'BR',
      mainCities: ['Rio Branco', 'Cruzeiro do Sul', 'Senador Guiomard', 'Sena Madureira'],
    ...
    },
    {
      name: 'America/Panama',
      alternativeName: 'Eastern Time',
      group: ['America/Panama', 'America/Atikokan', 'America/Cayman', 'America/Coral_Harbour'],
      continentCode: 'NA',
      continentName: 'North America',
      countryName: 'Panama',
      countryCode: 'PA',
    ...
    },
    {
      ...
      group: ['Pacific/Port_Moresby', 'Antarctica/DumontDUrville', 'Pacific/Chuuk', 'Pacific/Yap', 'Pacific/Truk'],
      continentCode: 'OC',
      continentName: 'Oceania',
    ...
    },
    {
      ...
      group: ['Pacific/Tarawa', 'Pacific/Funafuti', 'Pacific/Majuro', 'Pacific/Wake', 'Pacific/Wallis'],
      continentCode: 'OC',
      continentName: 'Oceania',
...
function i(
  { alternativeName: a, mainCities: e, rawOffsetInMinutes: i, currentTimeOffsetInMinutes: n },
  { useCurrentOffset: r = !1 } = {},
) {
  return `${(function (a) {
    const e = Math.abs(a),
      [i, n] = [Math.floor(e / 60), e % 60].map(a => a.toString().padStart(2, '0'));
    return `${a >= 0 ? '+' : '-'}${i}:${n}`;
  })(r ? n : i).padStart(6, '+')} ${a} - ${e.join(', ')}`;
}
const n = /^[A-Za-z_+-]{1,256}(:?\/[A-Za-z_+-]{1,256}(\/[A-Za-z_+-]{1,256})?)?$/,
  r = { year: 0, month: 1, day: 2, hour: 3, minute: 4, second: 5 };
function t(a, e) {
  return 'string' == typeof a && 'string' == typeof e ? a.localeCompare(e) : 0;
}
function o(a) {
  if ('number' != typeof a) return '';
  const e = (Math.abs(a) % 60).toString().padStart(2, '0'),
    i = Math.floor(Math.abs(a) / 60)
      .toString()
      .padStart(2, '0');
  return a >= 0 ? `+${i}:${e}` : `-${i}:${e}`;
}
function m() {
  const a = e
    .reduce(function (a, e) {
      const t = (function (a) {
        ...
        const [o, m, c, u, s, A] = t.formatToParts
          ? (function (a, e) {
              const i = a.formatToParts(e),
                n = [];
              for (let a = 0; a < i.length; a++) {
                const { type: e, value: t } = i[a],
                  o = r[e];
                void 0 !== o && (n[o] = parseInt(t, 10));
              }
              return n;
            })(t, i)
          : (function (a, e) {
              const i = a.format(e).replace(/\u200E/g, ''),
        ...
        return (
          (l -= C >= 0 ? C : 1e3 + C),
          ((function (a) {
            let e = Date.UTC(a.year, a.month - 1, a.day, a.hour, a.minute, a.second, a.millisecond);
            return a.year < 100 && a.year >= 0 && ((e = new Date(e)), e.setUTCFullYear(e.getUTCFullYear() - 1900)), +e;
          })({ year: o, month: m, day: c, hour: u, minute: s, second: A, millisecond: 0 }) -
            l) /
            6e4
        );
      })(e.name);
      if (!1 === t) return a;
      const o = { ...e, currentTimeOffsetInMinutes: t };
      return a.push({ ...o, currentTimeFormat: i(o, { useCurrentOffset: !0 }) }), a;
    }, [])
    .sort(
      (a, e) =>
        a.currentTimeOffsetInMinutes - e.currentTimeOffsetInMinutes ||
        t(a.alternativeName, e.alternativeName) ||
        t(a.mainCities[0], e.mainCities[0]),
    );
  const o = (function (a) {
    const e = [];
    return (
  ...
  return [
    ...[
      ...
      countryName: '',
      countryCode: '',
      rawOffsetInMinutes: a.offset,
      abbreviation: a.name,
      rawFormat: '',
      currentTimeOffsetInMinutes: a.offset,
      currentTimeFormat: '',
      mainCities: [],
    })),
    ...a,
