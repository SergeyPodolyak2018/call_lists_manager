...
const e = {
  ...
  c = class {
    constructor(o) {
      g(this, o),
        (this.guxdelete = a(this, 'guxdelete', 7)),
        (this.color = 'default'),
        (this.accent = 'default'),
        (this.value = void 0),
        (this.disabled = !1),
    ...
    removeTag() {
      !this.disabled && this.removable && this.guxdelete.emit(this.value);
    }
    onSlotChange(g) {
      const a = g.composedPath()[0].assignedNodes();
      this.label = a.map(g => g.textContent).join('');
    }
    renderTagTitle() {
      return o(
        'gux-tooltip-title',
    ...
    renderSrText() {
      return o(
        'div',
        { class: 'gux-sr-only' },
        this.i18n(this.disabled ? 'tag-disabled' : 'tag', { label: this.label }),
      );
    }
    renderRemoveButton() {
      if (this.removable)
    ...
    componentWillLoad() {
      l(this.root, { variant: this.removable ? 'removable' : 'permenant' });
    }
    async componentWillRender() {
      this.i18n = await u(this.root, e);
    }
    render() {
      return o(
        'div',
